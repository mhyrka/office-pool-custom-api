const sportsData = [ [ 'Cincinnati Bengals $$ Indianapolis Colts',
...
function createHomeAndAwayTeams(data) {
  return data.map((week, index) => {
    return {
      ...
      let currentGame = {away: current.split(' $$ ')[0], home: current.split(' $$ ')[1]}
...
let schedule = createHomeAndAwayTeams(sportsData)
